...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(33ccff55)", "rgba(00ff9933)"}, angle = 45 },
...
hl.bind(mainMod .. " + SHIFT + C", hl.dsp.window.pseudo())
...
-- rofimoji
hl.bind(mainMod .. " + SHIFT + SPACE", hl.dsp.exec_cmd("rofimoji"))
-- hyprlock
hl.bind(mainMod .. " + SHIFT + L", hl.dsp.exec_cmd("hyprlock"))
-- hyprshot
hl.bind(mainMod .. " + PRINT", hl.dsp.exec_cmd("hyprshot -m output"))
-- Wallpaper Changin' Scripy-thang
hl.bind  (mainMod .. " + C", hl.dsp.exec_cmd("~/.scripts/wallpaper/space.sh"))
