...
const key = "AIzaSyBLcnE95Y_E5QI118jUAikhLL4vPAIxPhQ"
const channelName = "mackenziegcriswell";
const color = "white";
    ...
    getChannelId(function(id){
      getChannelStatistics(id,function(arrayOfStats){
        addCommas(arrayOfStats, function(formattedArrayOfStats){
          console.log(""+formattedArrayOfStats[0]+"| color="+color+" image="+ youTubeIcon);
          console.log("---");
          console.log("Refresh|refresh=true");
          console.log("---");
